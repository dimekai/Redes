        ...
        try{
            ...
            while(true){
                ...
                if(op ==1){
                    ...
                    Persona p1  = new Persona(firstName,lastName,phone,birthDate,email,1);        
                    oos.writeObject(p1);
                    oos.flush();
                    ...
                    Persona p1  = new Persona(firstName,lastName,phone,birthDate,email,2); 
                    oos.writeObject(p1);
                    oos.flush();
                    ...
                    Persona p1v2  = new Persona(newfirstName,newlastName,newphone,newbirthDate,p2.getEmail(),3);           
                    ...
                    Persona p1  = new Persona(firstName,lastName,phone,birthDate,email,4); 
                    oos.writeObject(p1);
                    oos.flush();
                    ...
                    Persona p1  = new Persona(firstName,lastName,phone,birthDate,email,5); 
                    oos.writeObject(p1);
                    oos.flush();
