...
public class IP {
    ...
    private String TOStype(int code){
        String str = "";
        if(code == 0 || code == 1 || code == 2) str = "Prioridad";
        else if(code == 3) str = "Retardo";
        else if(code == 4) str = "Desempeño";
        else if(code == 5) str = "Confiabilidad";
        return str;
    }
